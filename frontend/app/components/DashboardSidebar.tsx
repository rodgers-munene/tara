...
export default function DashboardSidebar({ roleLabel, links, userName, onLogout }: DashboardSidebarProps) {
      ...
      >
        <div className="flex items-center gap-2 flex-1">
          ...
          <span
            ...
            style={{ background: "var(--sidebar-hover)", color: "var(--sidebar-text-dim)" }}
          >
            {roleLabel}
          </span>
        </div>
            ...
            <>
              ...
              >
                <div className="px-3 py-2 border-b mb-1" style={{ borderColor: "var(--border)" }}>
                  ...
                  <p className="text-[11px]" style={{ color: "var(--text-3)" }}>{roleLabel}</p>
                </div>
                <button
      ...
      >
        {links.map(({ href, label, icon: Icon }) => {
          ...
          return (
            ...
            >
              <Icon size={20} strokeWidth={active ? 2.5 : 1.8} className="transition-transform active:scale-90" />
              <span>{label}</span>
            </Link>
          );
        })}
      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 py-4 flex-shrink-0" style={{ borderTop: "1px solid var(--sidebar-hover)" }}>
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[11px]" style={{ color: "var(--sidebar-text-dim)" }}>
              {roleLabel}
            </p>
          </div>
          <button
